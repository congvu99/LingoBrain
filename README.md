...
- Lên cấp có điểm để đổ vào cây kỹ năng 5 nguyên tố (Lửa · Băng · Sét · Đất · Gió) — chọn trường phái là có **tuyệt kỹ** ngay từ đầu (không cần đạt bậc nào); điểm cộng vào nhánh mở hiệu ứng nội tại bậc 1–2, còn bậc 3 của nhánh đang dùng làm trường phái cộng thêm hệ số vào **tuyệt kỹ mạnh hơn** (cộng dồn với thưởng dạng tiến hoá cấp 16, xem bên dưới) — hiệu lực thật (số phép cường hoá, khiên, thời gian đóng băng…) tuỳ tuyệt kỹ, không phải một mức % cố định. Mỗi phép niệm đúng đầy dần **thanh tuyệt kỹ** (4 nấc, nạp rất nhanh nên dùng được nhiều lần mỗi trận); sau khi dùng tuyệt kỹ, thanh này ngừng nạp 6 giây (kể cả từ chiêu tự phát cộng thẳng) — ô hiện xám mờ trong lúc hồi. Đầy (và hết hồi) thì bấm nút ✨ hoặc Shift+Enter để vào **chuỗi niệm**: gõ liền 2 từ mới trong 12 giây, mỗi từ gõ trọn là 1 đòn sát thương và tính vào hiệu lực tuyệt kỹ cuối chuỗi (gõ đủ cả 2 từ = hiệu lực mạnh nhất, "HOÀN HẢO" — nhãn này chỉ hiện khi gõ đủ, không phải khi hệ số đủ cao nhờ thưởng; gõ thiếu hoặc hết giờ vẫn ra tuyệt kỹ nhưng yếu hơn, dù có thưởng hệ số).
- **7 chiêu tự phát mỗi hệ** (35 chiêu, "📖 Sổ chiêu" ở sảnh) mở dần theo cấp (1/2/3/4/6/8/10): mỗi từ niệm ra tối đa 1 chiêu đặc biệt theo điều kiện (từ dài, gõ nhanh, vừa chạm combo 3/6, quái dưới 30% HP, vừa bị đánh trúng…), ưu tiên nguy cấp > phản đòn > combo lớn > từ dài > gõ nhanh > combo nhỏ > chiêu thường.
- **Tiến hoá** ("🧬 Tiến hoá" ở sảnh): mỗi hệ có cây 1→2→4 dạng (30 dạng, cấp 8 mở 2 dạng, cấp 16 mở tiếp 2 dạng con của mỗi dạng cấp 8), đổi tự do giữa các dạng đã mở kể cả quay lại dạng gốc. Mỗi dạng đổi sprite nhân vật + chỉ số nhỏ + nâng cấp 2 chiêu; dạng cấp 16 còn cộng thêm hệ số tuyệt kỹ chuỗi niệm. Chưa đủ cấp thì hiện dạng gốc, không mất lựa chọn đã lưu. Báo "Có thể tiến hoá!" ở sảnh và màn kết trận khi đạt mốc.
