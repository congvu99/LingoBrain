...
**Bắn máy bay:** bấm **Bắt đầu** (iPhone: để bật bàn phím; khung chơi tự co vừa phần trên bàn phím). **Muốn hạ mục tiêu nào thì gõ từ của nó** — game không tự chọn thay bạn. Mọi mục tiêu có từ bắt đầu bằng chữ đang gõ đều hiện tiến độ (`s t u _ _ _ _ _`); chữ kế tiếp quyết định mục tiêu, đạn đang bay đổi hướng theo. Đổi ý giữa chừng cứ gõ từ khác, không cần xoá. Tàu của bạn nghiêng mình bay sang phía mục tiêu đang bắn. Hai từ trùng đầu như `give` / `give up`: gõ tiếp `up` để hạ `give up`, hoặc **Enter** để hạ `give`; Enter khi chưa gõ trọn từ nào thì xoá chữ đang gõ. Dấu cách, gạch nối tự bỏ qua. Gõ sai chỉ làm đạn bay trượt, không trừ điểm; sai 3 chữ trên cùng một mục tiêu thì từ đó được ôn trước. Mục tiêu chạm tàu: mất 1 ❤️, từ hiện màu đỏ và vào danh sách ôn trước. Đóng bàn phím, chuyển app, bấm ⏸ hoặc Esc thì tạm dừng. Nên tắt Telex/Unikey khi chơi.
