...
/* Hình lớn xuất hiện tại quái lúc phép bậc 3 chạm đích (js/boss-game-tier3-ultimate-fx.js vẽ) */
const BOSS_TIER3_CUSTOM = { fire: 'meteor', ice: 'pillar', storm: 'bolt', earth: 'spikes', wind: 'tornado' };
...
const BOSS_SPELL_PRESETS = {
  fire: {
    ...
    3: {   // Trận đồ đỏ dưới chân → thiên thạch rơi, rung màn
      ...
      circle: BOSS_TIER3_CIRCLE_COLOR.fire, custom: BOSS_TIER3_CUSTOM.fire
    }
  },
  ice: {
    1: {
    ...
    3: {   // Trận đồ xanh → cột băng trồi dưới quái, vỡ vụn
      ...
      circle: BOSS_TIER3_CIRCLE_COLOR.ice, custom: BOSS_TIER3_CUSTOM.ice
    }
  },
  storm: {
    1: {
    ...
    3: {   // Trận đồ tím → bão sét nhiều tia, loé trắng màn
      ...
      circle: BOSS_TIER3_CIRCLE_COLOR.storm, custom: BOSS_TIER3_CUSTOM.storm
    }
  },
  earth: {
    1: {
    ...
    3: {   // Trận đồ nâu → gai đá mọc quanh quái, bụi mù
      ...
      circle: BOSS_TIER3_CIRCLE_COLOR.earth, custom: BOSS_TIER3_CUSTOM.earth
    }
  },
  wind: {
    1: {
    ...
    3: {   // Trận đồ ngọc → lốc lớn nâng quái rồi quật xuống
      ...
      circle: BOSS_TIER3_CIRCLE_COLOR.wind, custom: BOSS_TIER3_CUSTOM.wind
    }
  }
};
...
/* Dữ liệu tuyệt kỹ (js/boss-game-tier3-ultimate-fx.js vẽ) — name = tên hiện giữa màn cắt cảnh */
const BOSS_ULTIMATE_PRESETS = {
  meteor: { name: 'Mưa Sao Băng', color: '#ff5a1f', shake: 16, flash: 0.5, hits: 5 },
  iceAge: { name: 'Kỷ Băng Hà', color: '#4fd3ff', shake: 4, flash: 0.3, hits: 0 },
  chain: { name: 'Xích Sét', color: '#b06bff', shake: 12, flash: 0.5, hits: 4 },
  revive: { name: 'Hồi Sinh', color: '#ffe08a', shake: 0, flash: 0.35, hits: 0 },
  tornado: { name: 'Lốc Xoáy', color: '#3fe8b0', shake: 10, flash: 0.2, hits: 0 }
};
