...
| 3 | Phép bậc 2–3, 5 tuyệt kỹ, hiệu ứng nội tại | [phase-03-tier-spells-ultimates-and-passive-fx.md](phase-03-tier-spells-ultimates-and-passive-fx.md) | 2 | completed |
| 4 | Quái (5 dáng → 12 con), nền vùng, dữ liệu 28 đoạn truyện, thẻ truyện, Nhật ký | [phase-04-monsters-regions-and-story.md](phase-04-monsters-regions-and-story.md) | 1, 2 | completed |
| 5 | Hub đầy đủ: chọn pháp sư, cây nguyên tố, trường phái, buff Ôn từ, kết trận, luồng truyện | [phase-05-hub-skill-tree-and-battle-flow.md](phase-05-hub-skill-tree-and-battle-flow.md) | 2, 4 | completed |
| 6 | Tích hợp: sync/backup, bảng người dùng hợp đồng, PWA, docs, cân bằng, FPS iPhone | [phase-06-integration-sync-pwa-docs-balance.md](phase-06-integration-sync-pwa-docs-balance.md) | 3, 5 | in-progress |
